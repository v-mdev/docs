...
This will help you getting started with the [OpenApiToolkit](/oss/javascript/integrations/tools/openapi). For detailed documentation of all OpenApiToolkit features and configurations head to the [API reference](https://api.js.langchain.com/classes/langchain.agents.OpenApiToolkit.html).
